...
public class EndScreen extends ScreenAdapter {
  CircleGameAlpha game;
  final ShapeRenderer shapeRenderer;
  final SpriteBatch sb;
  final BitmapFont font;

  public EndScreen(CircleGameAlpha game) {
    this.game = game;
  ...
  public void render(float delta) {
    ...
    font.draw(sb, "Total circles eaten: " + game.playerInfo.getScore(), Gdx.graphics.getWidth() * .25f, Gdx.graphics.getHeight() * .5f);
